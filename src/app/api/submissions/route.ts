...
export async function POST(request: NextRequest) {
  try {
    ...
    const data = {
      ...
      preferredStyles: JSON.parse((formData.get("preferredStyles") as string) || "[]"),
      preferredAtmosphere: (formData.get("preferredAtmosphere") as string) || "",
      currentProblems: JSON.parse((formData.get("currentProblems") as string) || "[]"),
